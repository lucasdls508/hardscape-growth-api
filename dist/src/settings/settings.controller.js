...
const unScapeHtml_1 = require("../utils/unScapeHtml");
let SettingsController = class SettingsController {
    ...
    async getPrivacyPolicy(key) {
        const content = await this._settingsService.getRawSettingKey(key);
        return { content: (0, unScapeHtml_1.unescapeHtml)(content) };
    }
    updateSetting(key, content) {
...
__decorate([
    ...
    (0, common_1.Render)("instruction"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], SettingsController.prototype, "getInstruction", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
...
__decorate([
    (0, common_1.Get)(":key/preview"),
    (0, common_1.Render)("privacy"),
    __param(0, (0, common_1.Param)("key")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], SettingsController.prototype, "getPrivacyPolicy", null);
__decorate([
    (0, common_1.Put)(":key"),
    __param(0, (0, common_1.Param)("key")),
