...
exports.SocketModule = SocketModule = __decorate([
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([messages_entity_1.Messages, conversations_entity_1.Conversations]),
            ...
            bull_1.BullModule.registerQueue({ name: "product" }, { name: "notifications" }),
